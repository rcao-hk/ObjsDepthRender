...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--root_path', type=str, default='/home/user/dataset/graspnet/scenes/', help='path to the root folder')
        parser.add_argument('--output_path', type=str, default='/home/user/dataset/graspnet/virtual_scenes/', help='path to the output folder')
