...
class SceneRenderOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--meshes_path', type=str, default='E:/Datasets/LineMod/Linemod_preprocessed/models/', help='path to one example')
        parser.add_argument('--meshes_name', type=str, default='.ply', help='obj_xx.ply')
